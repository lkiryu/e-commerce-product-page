...
export default function ProductInfo() {
    const { productData, setProductData, productTotalPrice } = useContext(CartContext)
    const { company, name, description, price, discount, cartQuantity } = productData
    ...
    return (
        <div className="w-[450px]">
            ...
            <div className="flex justify-between">
                ...
                <button className="flex items-center justify-center w-64 text-very-dark-blue bg-orange hover:opacity-50 transition gap-2 p-4 cursor-pointer rounded-xl font-bold">
